 ...
 */
public class IntervalSolvtyNodePlugin extends Plugin {
    // The shared instance.
    private static IntervalSolvtyNodePlugin plugin;

    /**
     * The constructor.
     */
    public IntervalSolvtyNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IntervalSolvtyNodePlugin getDefault() {
        return plugin;
    }
